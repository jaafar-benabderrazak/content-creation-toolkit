...
Plans:
- [ ] 01-01: Define PipelineConfig Pydantic model with nested VideoSettings, PublishSettings, NotifySettings and YAML round-trip
- [ ] 01-02: Create three starter YAML profile files (lofi_study, tech_tutorial, cinematic) under config/profiles/
- [ ] 01-03: Wire config loading into both existing pipelines via --config CLI argument (read-only, no behavior change yet)
- [ ] 01-04: Add schema validation tests covering missing fields, wrong types, and unknown fields
